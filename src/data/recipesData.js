export const recipesData = [
  ...
  {
    id: 61,
    title: "Steamed Dumpling Stew",
    category: "dinner",
    cuisine: "Mexican",
    difficulty: "medium",
    cookTime: 45,
    servings: 3,
    image: "/assets/images/recipes/steamedDumplingStew.jpg",
    videoUrl: "https://www.youtube.com/embed/np3Mg0NvrZE?si=pZN3gN3h7RlRFibN",
    ingredients: [
    ...
    instructions: [
      ...
      "Gradually add warm water and mix to form a soft dough",
      "Knead the dough lightly and set aside",
      "Heat oil in a large pot over medium heat",
      "Brown the beef and add the onion and garlic",
      "Add the mixed vegetables, beef stock, and seasonings",
      "Cover and simmer until the meat is tender and the stew has thickened",
      "Divide the dumpling dough into small portions and shape into balls",
      "Place the dumplings on top of the stew",
      "Cover the pot tightly and steam the dumplings for 15–20 minutes",
      "Check that the dumplings are cooked through",
      "Taste and adjust seasoning",
      "Serve the steamed dumplings with the stew immediately",
    ],
  },
  {
    id: 62,
